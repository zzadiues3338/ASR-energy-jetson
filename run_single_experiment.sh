...
# Strip any trailing commas or unwanted characters from MODEL_NAME and EXTRA_KWARGS
...
FULL_OUTPUT=$(jetson-containers run -d -v /home/chakz/Desktop/noisy_20_files:/app/audio -v /home/chakz/Desktop/outputs:/app/outputs $IMAGE_TAG)
